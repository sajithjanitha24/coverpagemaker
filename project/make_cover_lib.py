...
def get_user_input():
    ...
    topic_lines = []
    default_topic_line1 = "USER MANUAL TO ASSEMBBLE PC AND INSTALL OS"
    default_topic_line2 = "AND RELATED SOFTWARE CONFIGURATION FOR ADVANCED SYSTEM SETUP"
    ...
    data['regNo'] = get_input("Your Reg No", "COL/EE/2324/F/217")
...
def create_cover_page(data):
    ...
    try:
        ...
        c.setFont(DEFAULT_FONT, 14) # Approx 5mm
        line_height = 10 * mm
        ...
        topic_style = ParagraphStyle(
            ...
            fontSize=20,          # Approx 7mm
            leading=28,           # Approx 10mm line-height
            alignment=TA_CENTER,
            underlineWidth=0.5,
            underlineColor='#000000',
            underlineOffset = -2.5 * mm
        )
        ...
        y_pos = y_topic_bottom - (5 * mm) # 5mm gap below topic
        c.setFont(DEFAULT_FONT, 10) # Approx 3mm
